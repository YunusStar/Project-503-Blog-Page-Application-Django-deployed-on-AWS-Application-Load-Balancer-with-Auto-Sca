...
DATABASES = {
    'default': {
        ...
        'HOST': 'project-rds-01.czx40ulw0rwj.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'project-s3-1' # please enter your s3 bucket name
